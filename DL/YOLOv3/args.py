...
### Some paths
train_file = r'C:\Users\soma\SMART_Referee\SMART_Referee_DL\data\training_data\labeling_data\ball_data\result\train_03.txt'  # The path of the training txt file.
val_file = r'C:\Users\soma\SMART_Referee\SMART_Referee_DL\data\training_data\labeling_data\ball_data\result\val_03.txt'  # The path of the validation txt file.
# restore_path = './data/darknet_weights/yolov3.ckpt'
restore_path = r'C:\Users\soma\SMART_Referee\SMART_Referee_DL\YOLOv3\data\darknet_weights\yolov3.ckpt'  # The path of the weights to restore.
...
class_name_path = './data/my_data/SMART_Referee.names'  # The path of the class names.

### Training releated numbers
batch_size = 8 # default : 6
